/**
 * Live tests for Progressive Steam Game Loading
 * 
 * These tests use real rate limiting delays and should be run sparingly.
 * They test the actual progressive loading functionality with real timing.
 * 
...
describe('Steam Progressive Loading Live Tests', () => {
    ...
    describe('Progressive Loading Core', () => {
        ...
        }, 15000) // 15 second timeout for live test
