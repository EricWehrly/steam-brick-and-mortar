...
export const ANONYMOUS_STORE_USER: SteamUser = {
    ...
    games: [
        ...
        { appid: 3164330, name: 'Infinity Nikki',       playtime_forever: 4500,  img_icon_url: '', img_logo_url: '', artwork: { icon: '', logo: '', header: header(1091298), library: lib(1091298) }, genres: F2P_RPG    },
