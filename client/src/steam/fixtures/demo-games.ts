...
export const ANONYMOUS_STORE_USER: SteamUser = {
    ...
    games: [
        ...
        { appid: 3224770, name: 'Umamusume: Pretty Derby',  playtime_forever: 4000,  img_icon_url: '', img_logo_url: '', artwork: { icon: '', logo: '', header: header(3224770), library: lib(3224770) }, genres: F2P_RPG    },
