 ...
 * these displayed menus using in-world controls and buttons. The tabs [VRSettingsMenuShell's tab
 * buttons] should already do that, a little." A real in-world trigger for this panel is follow-up
 * work, not a keyboard-shortcut stand-in.
 *
