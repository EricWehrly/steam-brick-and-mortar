 ...
 *
 * Scope note: this coordinator owns artwork/placement progress events only.
 * Definitions-ready signaling (GameDataReady) is emitted by SteamIntegration
 * when steam.games is committed to DataManager.
 */
