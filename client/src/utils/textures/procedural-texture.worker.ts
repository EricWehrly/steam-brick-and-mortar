 ...
 */
function paintWoodPlanks(data: Uint8ClampedArray, width: number, height: number, opts: {
    numPlanks: number
 ...
 */
function paintCeilingPopcorn(data: Uint8ClampedArray, width: number, height: number, opts: {
    color: string
    bumpDensity: number
    bumpHeight: number
    detailScale: number
 ...
 */
function paintCeilingPopcornNormal(data: Uint8ClampedArray, width: number, height: number, opts: {
    bumpDensity: number
    detailScale: number
    strength: number
}): void {
