...
- **Room variant — cozy basement** — lower ceilings, warmer lighting, carpet, wood paneling
...
- **Dynamic spoke/aisle shelf arrangement** — shelves as spokes per category, or giant aisles running past; 4-6 day estimate post-Act 2 core
...
- **Community management** — Discord/forums, code of conduct, moderation, beta programs (Story 9.4.2)
- **A/B testing framework** — for feature improvements and UX experiments (Story 9.3.2)
