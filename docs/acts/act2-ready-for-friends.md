...
- [Local File Investigation](../features/local-file-investigation.md) — user categories from Steam local files; research done, implementation is the experiment; invest to try, not required
